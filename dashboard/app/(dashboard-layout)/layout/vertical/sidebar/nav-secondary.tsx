    ...
    return (
        <div className="-mx-4 border-t border-b border-border px-5 py-5">
            <div className="flex flex-col gap-5">
                ...
                {/* Upgrade button */}
                <Link href={"https://shadcndashboard.dev/pricing"} target='_blank' className="w-full cursor-pointer h-9 flex items-center justify-center bg-foreground text-background hover:bg-foreground/90 rounded-lg text-sm font-medium">
                    Upgrade
                </Link>
            </div>
        </div>
